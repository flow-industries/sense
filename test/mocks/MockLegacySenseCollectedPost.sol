...
import "contracts/core/base/SenseERC721.sol";
...
/**
 * @notice A contract that represents a Sense Collected Post.
 *
 * @dev This contract is used to store the metadata of a Sense Collected Post.
 * It inherits from SenseERC721 and implements the IERC7572 interface.
 ...
 * Collect creation.
 */
contract MockLegacySenseCollectedPost is SenseERC721, IERC7572 {
    event Sense_SenseCollectedPost_Transfer(address indexed from, address indexed to, uint256 indexed tokenId);
    ...
    constructor(address feed, uint256 postId, bool isImmutable) {
        SenseERC721._initialize("Sense Collected Post", "SCP", ITokenURIProvider(address(0)));
    ...
    function _afterTokenTransfer(address from, address to, uint256 tokenId) internal virtual override {
        emit Sense_SenseCollectedPost_Transfer(from, to, tokenId);
    }

    // Disabling integrated SenseERC721 tokenURIProvider

...
contract SenseUsernameTokenURIProvider is ITokenURIProvider {
    ...
    function _emitSenseContractDeployedEvent() internal virtual {
        emit Events.Sense_Contract_Deployed({
            contractType: "sense.contract.TokenURIProvider",
            flavour: "sense.contract.TokenURIProvider.SenseUsernameTokenURIProvider"
        });
    }

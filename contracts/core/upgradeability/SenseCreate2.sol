...
address constant SENSE_CREATE_2_ADDRESS = 0x52AF9CF29976C310E3DE03C509E108edB6edb8c0;

interface ISenseCreate2 {
...
contract SenseCreate2 is ISenseCreate2, Initializable, Ownable {
    ...
    constructor() {
        address proxy = address(new TransparentUpgradeableProxy(SENSE_CREATE_2_ADDRESS, SENSE_CREATE_2_ADDRESS, ""));
        ...
        SENDER_BYTES = bytes32(uint256(uint160(SENSE_CREATE_2_ADDRESS)));
        CONSTRUCTOR_ARGS_HASH = keccak256(abi.encode(SENSE_CREATE_2_ADDRESS, SENSE_CREATE_2_ADDRESS, ""));
    ...
    function createTransparentUpgradeableProxy(
        ...
        ITransparentUpgradeableProxy proxy = ITransparentUpgradeableProxy(
            address(new TransparentUpgradeableProxy{salt: salt}(SENSE_CREATE_2_ADDRESS, SENSE_CREATE_2_ADDRESS, ""))
        );
